...
export const EmergencyHUDModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-black/60 backdrop-blur-sm overflow-y-auto p-4 sm:p-6 animate-fadeIn">
      {/* Container Box */}
      <div className="w-full max-w-7xl mx-auto bg-mine-surface border-2 border-status-critical rounded-lg shadow-2xl overflow-hidden flex flex-col my-auto">
        {/* Top Critical Alert Bar */}
        <div className="flex items-center justify-between border-b border-status-critical bg-status-critical-bg px-6 py-4">
        ...
        {/* Footer */}
        <div className="bg-mine-surface-alt border-t border-mine-border px-6 py-3 flex justify-between items-center text-xs text-mine-text-secondary">
